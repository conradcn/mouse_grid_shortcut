This is a very simple assistive/productivity tool that registers a keyboard shortcut (default ctrl+alt+m) to launch a mouse grid.
...
<img width="1634" height="1847" alt="image" src="https://github.com/user-attachments/assets/3eba9045-e8ad-415a-9f16-fa060340ff1c" />

This is a customized version of the overlay that's designed to be as fast as possible. Once the grid is up, enter the numbers to move the mouse to that cell. As you enter numbers, the grid keeps subdividing, so you can be as precise as you want.
